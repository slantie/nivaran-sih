...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) { return <div className={cn("rounded-xl border border-[#dbe5e4] bg-white shadow-[0_1px_3px_rgba(15,48,71,.06)]", className)} {...props} />; }
